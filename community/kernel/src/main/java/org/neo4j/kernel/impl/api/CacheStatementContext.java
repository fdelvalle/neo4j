...
public class CacheStatementContext implements StatementContext
{
    private final StatementContext actual;
    private final NodeManager nodeManager;
    private final PersistenceCache cache;

    public CacheStatementContext( StatementContext actual, NodeManager nodeManager,
    ...
    {
        // This gets called during commit
//        cache.commitLabels( nodeId,  );
